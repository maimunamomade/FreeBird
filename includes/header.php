        ...
        <div class="collapse navbar-collapse" id="navbarnav">
            ...
            <ul class="navbar-nav">
                ...
                <?php if (!isset($_SESSION['seller_user_name'])) { ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" data-toggle="modal" data-target="#register-modal"> Become A Seller </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="btn btn-primary btn-sm" href="#" data-toggle="modal" data-target="#register-modal"> Sign Up </a>
                    </li>
...
<!-- modal fade for id= register-model starts-->
        ...
        <div class="modal-form register modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="" method="post">
                    ...
                    <!--form group starts-->
                    <div class="form-group">
                        <label class="form-control-label font-weight-bold"> User Name </label>
                        <input type="text" class="form-control" name="u_name" placeholder="Enter Your User Name" required>

                        <small class="form-text text-muted">
                            ! Important User Name can not be changed once an account is registered.
                        </small>
                    </div>
                    <!--form group ends-->
...
<!-- modal fade for id= login-model starts-->
<div class="modal fade" id="login-modal">

    <!--modal dialog starts-->
    <div class="modal-dialog">

        <!--modal form content starts-->
        <div class="modal-form modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-center mt-3">
                    ...
                    <a href="#" data-toggle="modal" data-target="#register-modal" data-dismiss="modal"> Register
                    </a>

                    &nbsp;&nbsp; | &nbsp;&nbsp;

                    <a href="#" data-toggle="modal" data-target="#forgot-modal" data-dismiss="modal"> Forgot Password
                    </a>
        ...
        <!--modal form content ends-->

    </div>
    <!--modal dialog ends-->

</div>
<!-- modal fade for id= login-model ends-->


<!-- modal fade for forgot password modal starts -->
        ...
        <div class="modal-form modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text-muted text-center mb-2">
                    ...
                    Enter your FreeBird profile email & we’ll send you a password reset link.
...
<!-- modal fade for forgot password modal ends -->
